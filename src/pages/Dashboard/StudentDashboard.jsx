  ...
  return (
    <section className="min-h-screen bg-white    transition-colors p-6">
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          ...
          <button
            ...
            className="px-4 py-2 bg-slate-100   :bg-slate-800 text-slate-900   :text-white rounded-lg border border-gray-200   :border-slate-700"
          >
            Bookmarked Papers
          </button>
          <button
            onClick={gotoDownloadFinal}
            className="px-4 py-2 border border-slate-200   :border-slate-700 rounded-lg text-slate-900   :text-white"
          >
          ...
          <Link
            ...
            className={`px-4 py-2 rounded-lg border ${
              currentUser?._id
                ? "border-slate-200   :border-slate-700 text-slate-900   :text-white hover:bg-slate-100   :hover:bg-slate-800"
                : "border-slate-200   :border-slate-700 text-slate-400 cursor-not-allowed"
            }`}
            onClick={(e) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {loading ? (
                ...
                <div className="space-y-3">
                  {proposals.map((p) => (
                    <div
                      key={p._id || p.id}
                      className="p-3 rounded-lg border border-gray-100   :border-slate-700 bg-slate-50   "
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <p className="text-sm text-slate-600   :text-gray-400 truncate max-w-xl">
                            {p.abstract}
                          </p>
              ...
              {feedbacks.length === 0 ? (
                ...
                <ul className="space-y-3">
                  {feedbacks.slice(0, 5).map((fb) => (
                    ...
                    >
                      <div className="text-sm text-slate-700   :text-gray-300">
                        {fb.comment}
                      </div>
          ...
          <aside className="space-y-6">
                ...
                <ul className="space-y-3">
                  {deadlines.slice(0, 6).map((d) => (
                    <li key={d._id || d.id} className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="text-sm text-slate-900   :text-white">
                          {d.title}
                        </div>
            ...
            <div className="bg-white   :bg-slate-800 rounded-lg p-5 shadow border border-gray-200   :border-slate-700">
              ...
              {joinRequests.length > 0 && (
                <p className="mt-2 text-xs text-slate-500   :text-gray-400">
            ...
            <div className="bg-white   :bg-slate-800 rounded-lg p-5 shadow border border-gray-200   :border-slate-700">
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  className="text-left px-3 py-2 rounded hover:bg-slate-50   :hover:bg-slate-700 flex items-center gap-2 w-full"
                >
      ...
      {showMeetingModal && (
        ...
        >
          <div className="bg-white   :bg-slate-800 rounded-lg p-6 w-full max-w-4xl max-h-[80vh] overflow-hidden">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-600   :hover:text-slate-300"
              >
                ✕
              </button>
            </div>
                    ...
                    return (
                      <div
                        ...
                        className={`p-4 rounded-lg border ${
                          isPast
                            ? "border-gray-200   :border-slate-600 bg-gray-50   :bg-slate-700"
                            : "border-blue-200   :border-blue-700 bg-blue-50   :bg-slate-700"
                        }`}
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="text-sm text-slate-600   :text-gray-400 mt-1">
                              <div>
