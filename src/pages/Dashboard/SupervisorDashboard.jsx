    ...
    <section className="min-h-screen bg-white dark:bg-slate-900 p-6 transition-colors">
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap gap-3 mb-6">
          <button className="px-4 py-2 bg-[#7b1e3c] text-white rounded-lg">Create Announcement</button>
          <button className="px-4 py-2 border border-[#7b1e3c] text-[#7b1e3c] rounded-lg">Search arXiv</button>
          <button className="px-4 py-2 bg-slate-100 dark:bg-slate-800 rounded-lg">View All Theses</button>
        </div>
          ...
          {loading ? (
              ...
              {proposals.map((p) => (
                <li key={p._id || p.id} className="p-3 rounded border border-gray-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
                  ...
                  <div className="text-xs text-slate-500 dark:text-gray-400 mb-1">
                    {p.groupName|| "Unknown Student"} — {new Date(p.createdAt).toLocaleDateString()}
                  </div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg p-5 shadow border border-gray-200 dark:border-slate-700">
              ...
              <div className="flex flex-col gap-2">
                <button className="text-left px-3 py-2 rounded hover:bg-slate-50 dark:hover:bg-slate-700">Search arXiv</button>
                <button className="text-left px-3 py-2 rounded hover:bg-slate-50 dark:hover:bg-slate-700">View Recommendations</button>
                <button className="text-left px-3 py-2 rounded hover:bg-slate-50 dark:hover:bg-slate-700">Schedule Meeting</button>
