                        ...
                        <div>
                          ...
                          <div className="text-xs mt-2">
                            {(s.proposals || []).slice(0, 2).map((p) => (
                              <span key={p._id || p.id} className={`inline-block px-2 py-1 mr-2 rounded-full text-xs ${p.status === "Approved" ? "bg-green-100 text-green-800" : p.status === "Rejected" ? "bg-red-100 text-red-800" : "bg-yellow-100 text-yellow-800"}`}>
                                {p.title} — {p.status}
                              </span>
                            ))}
                          </div>
